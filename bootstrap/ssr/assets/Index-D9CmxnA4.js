...
import { Trash2, Tag, ChevronLeft, ChevronRight, CalendarDays, PenTool, Edit2, Calendar, Sparkles, Search, Filter, Frown, Meh, Smile } from "lucide-react";
      ...
      children: [
        ...
        showCategoryModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg p-6 w-96 shadow-xl", children: [
          ...
          /* @__PURE__ */ jsx("form", { onSubmit: submitCategory, className: "mb-6", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
            ...
            /* @__PURE__ */ jsx("button", { type: "submit", className: "bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 text-sm font-medium", children: "Add" })
          ] }) }),
        ...
        /* @__PURE__ */ jsx("div", { className: "py-6", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto sm:px-6 lg:px-8", children: view === "calendar" ? (
          ...
          /* @__PURE__ */ jsxs("div", { className: `${selectedEntryId !== null || isEditing ? "hidden md:flex" : "flex"} w-full md:w-1/3 bg-white rounded-lg shadow-sm flex-col overflow-hidden`, children: [
          ...
          /* @__PURE__ */ jsx("div", { className: `${selectedEntryId === null && !isEditing ? "hidden md:flex" : "flex"} w-full md:flex-1 bg-white rounded-lg shadow-sm overflow-hidden flex-col h-full`, children: selectedEntryId === null && !isEditing ? (
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-6 border-b flex justify-between items-center sticky top-0 bg-white z-10", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxs("h2", { className: "text-xl font-bold text-gray-900 flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(PenTool, { className: "w-5 h-5 text-indigo-600 hidden md:block" }),
                  selectedEntryId ? isEditing ? "Edit Entry" : "View Entry" : "New Entry"
                ] })
              ] }),
              selectedEntryId && !isEditing && /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx(Edit2, { className: "w-4 h-4" }),
                      /* @__PURE__ */ jsx("span", { className: "hidden md:inline", children: "Edit" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx(Trash2, { className: "w-4 h-4" }),
                      /* @__PURE__ */ jsx("span", { className: "hidden md:inline", children: "Delete" })
                    ]
                  }
                )
              ] })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto p-6 mobile-pb-24", children: !isEditing && selectedEntry ? (
              // View Mode
              /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-gray-900 mb-2", children: selectedEntry.title || moment(selectedEntry.date).format("MMMM Do, YYYY") }),
