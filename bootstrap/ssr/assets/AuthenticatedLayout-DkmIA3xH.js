...
function ResponsiveNavLink({
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      ...props,
      className: `flex w-full items-start border-l-4 py-2 pe-4 ps-3 ${active ? "border-purple-400 bg-purple-50 text-purple-700 focus:border-purple-700 focus:bg-purple-100 focus:text-purple-800" : "border-transparent text-gray-600 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-800 focus:border-gray-300 focus:bg-gray-50 focus:text-gray-800"} text-base font-medium transition duration-150 ease-in-out focus:outline-none ${className}`,
      children
    }
  );
}
function Authenticated({ header, children, customNav }) {
  ...
  const isCrmModule = currentUrl.startsWith("/contacts") || currentUrl.startsWith("/lead-stages");
  if (isCrmModule) {
    navItems = [
      { name: "Master", route: "dashboard", icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" },
      ...
      { name: "Leads", route: "tasks.index", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" },
      { name: "Lead Stages", route: "lead-stages.index", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" }
    ];
  }
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-50 flex", children: [
    /* @__PURE__ */ jsxs("div", { className: "hidden md:flex md:flex-col md:w-64 bg-purple-900 text-white flex-shrink-0 transition-all duration-300 ease-in-out", children: [
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center h-16 bg-purple-900 border-b border-purple-800 shadow-sm", children: /* @__PURE__ */ jsx(Link, { href: "/", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "text-xl font-bold tracking-wider", children: /* @__PURE__ */ jsx("span", { className: "text-white", children: "PersonalSuite" }) })
      ] }) }) }),
      /* @__PURE__ */ jsx("div", { className: "flex flex-col flex-1 overflow-y-auto pt-5 pb-4", children: /* @__PURE__ */ jsx("nav", { className: "flex-1 px-3 space-y-1", children: navItems.map((item) => /* @__PURE__ */ jsxs(
        Link,
        {
          ...
          className: `group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200
                                    ${route().current(item.route.split(".")[0] + "*") ? "bg-purple-800 text-white shadow-md border-l-4 border-yellow-400" : "text-purple-100 hover:bg-purple-800 hover:text-white hover:pl-4"}`,
          children: [
            /* @__PURE__ */ jsx("svg", { className: `mr-3 flex-shrink-0 h-5 w-5 ${route().current(item.route.split(".")[0] + "*") ? "text-yellow-400" : "text-purple-300 group-hover:text-white"}`, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: item.icon }) }),
            item.name
          ]
        },
        item.name
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "md:hidden bg-purple-900 shadow-md h-16 flex items-center justify-between px-4 z-10 border-b border-purple-800", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2", children: [
          /* @__PURE__ */ jsx(ApplicationLogo, { className: "h-8 w-8 text-yellow-400 fill-current" }),
          /* @__PURE__ */ jsx("div", { className: "font-bold text-lg text-white", children: "My CRM" })
        ] }),
        /* @__PURE__ */ jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: (showingNavigationDropdown ? "block" : "hidden") + " md:hidden bg-white border-b border-gray-200 shadow-lg absolute top-16 w-full z-20", children: [
        /* @__PURE__ */ jsx("div", { className: "pt-2 pb-3 space-y-1", children: navItems.map((item) => /* @__PURE__ */ jsx(ResponsiveNavLink, { href: route(item.route), active: route().current(item.route.split(".")[0] + "*"), children: item.name }, item.name)) }),
        /* @__PURE__ */ jsxs("div", { className: "pt-4 pb-1 border-t border-gray-200 bg-gray-50", children: [
      ...
      /* @__PURE__ */ jsxs("main", { className: "flex-1 overflow-x-hidden overflow-y-auto bg-gray-50", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-8 px-8", children })
      ] })
    ] })
  ] });
}
