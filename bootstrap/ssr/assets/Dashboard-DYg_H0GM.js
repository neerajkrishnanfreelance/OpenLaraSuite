    ...
    Authenticated,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-4 gap-6", children: [
          /* @__PURE__ */ jsx("div", { className: "lg:col-span-3", children: /* @__PURE__ */ jsx(GanttWidget, { tasks: tasks || [] }) }),
          ...
          /* @__PURE__ */ jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsx("a", { href: "/stocks", className: "block bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "p-4 bg-purple-100 rounded-full mb-3", children: /* @__PURE__ */ jsx("svg", { className: "w-8 h-8 text-purple-600", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" }) }) }),
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-indigo-600 mb-1", children: "Stocks" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600", children: "Track investments" })
          ] }) }) })
        ] }),
        /* @__PURE__ */ jsx(
          CreateTaskModal,
