...
import { Users, Calculator, GraduationCap, PiggyBank, Heart, Receipt, BookOpen, Calendar, CheckSquare, PenTool, Compass } from "lucide-react";
  ...
  const tools = [
    {
      ...
      // Linking to projects as CRM placeholder
    },
    {
      title: "Accounting",
    ...
    },
    {
      ...
      // Using timesheets as expense placeholder
    },
    {
      title: "Learning 2",
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-50 font-sans text-gray-900", children: [
      /* @__PURE__ */ jsx("header", { className: "bg-white border-b border-gray-100 sticky top-0 z-10 transition-shadow hover:shadow-sm", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center h-16", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "p-2 bg-indigo-600 rounded-lg shadow-lg shadow-indigo-200", children: /* @__PURE__ */ jsx(Compass, { className: "w-6 h-6 text-white" }) }),
          /* @__PURE__ */ jsx("span", { className: "text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600", children: "My Personal Hub" })
        ] }),
      ...
      /* @__PURE__ */ jsxs("footer", { className: "py-8 text-center text-sm text-gray-400", children: [
        ...
        " My Personal Hub. All rights reserved."
      ] })
    ] })
  ] });
}
