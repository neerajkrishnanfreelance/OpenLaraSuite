      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-sm rounded-lg border border-gray-200 p-4 h-full", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-sm rounded-lg border border-gray-200 p-4", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "space-y-3", children: project.notes && project.notes.length > 0 ? project.notes.map((note) => /* @__PURE__ */ jsxs(Link, { href: route("notes.edit", note.id), className: "block p-3 bg-yellow-50 rounded-lg border border-yellow-100 hover:border-yellow-300 transition group", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
                  /* @__PURE__ */ jsx("h4", { className: "font-semibold text-gray-800 text-sm group-hover:text-indigo-600 truncate", children: note.title || "Untitled Note" }),
                  /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-400", children: new Date(note.created_at).toLocaleDateString() })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 mt-2 text-xs text-gray-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center", title: `Created by ${note.user.name}`, children: [
                  /* @__PURE__ */ jsx("div", { className: "h-4 w-4 rounded-full bg-gray-200 text-gray-600 flex items-center justify-center text-[9px] font-bold mr-1", children: note.user.name.charAt(0) }),
                  /* @__PURE__ */ jsx("span", { children: note.user.name })
                ] }) })
              ] }, note.id)) : /* @__PURE__ */ jsx("div", { className: "text-center py-4", children: /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400 italic", children: "No notes attached." }) }) })
            ] })
          ] })
        ] }),
