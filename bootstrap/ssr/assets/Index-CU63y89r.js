...
function Index({ auth, tasks, projects, users, filters }) {
  ...
  const columns = [
    { key: "title", label: "Title", render: (item) => /* @__PURE__ */ jsx(Link, { href: route("tasks.edit", item.id), className: "font-semibold text-indigo-600 hover:underline", children: item.title }) },
  ...
  const actions = (item) => /* @__PURE__ */ jsxs("div", { className: "flex space-x-2", children: [
          ...
          viewMode === "list" ? /* @__PURE__ */ jsx(
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
              (tasks.data || tasks).filter((t) => t.status === status).map((task) => /* @__PURE__ */ jsxs("div", { className: "bg-white p-3 rounded shadow-sm border border-gray-200", children: [
                ...
                /* @__PURE__ */ jsx(Link, { href: route("tasks.edit", task.id), className: "font-medium text-gray-900 hover:text-indigo-600 block mb-1", children: task.title }),
                /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500 mb-2", children: task.project?.name }),
