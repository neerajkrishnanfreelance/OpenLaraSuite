...
function Authenticated({ header, children }) {
  ...
  const navItems = [
    ...
    // Changed Icon for Meetings slightly to distinguish
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-50 flex", children: [
    /* @__PURE__ */ jsxs("div", { className: "hidden md:flex md:flex-col md:w-64 bg-purple-900 text-white flex-shrink-0 transition-all duration-300 ease-in-out", children: [
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center h-16 bg-purple-900 border-b border-purple-800 shadow-sm", children: /* @__PURE__ */ jsx(Link, { href: route("dashboard"), children: /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2", children: [
        /* @__PURE__ */ jsx(ApplicationLogo, { className: "h-8 w-8 text-yellow-400 fill-current" }),
        /* @__PURE__ */ jsxs("h1", { className: "text-xl font-bold tracking-wider", children: [
          "My ",
          /* @__PURE__ */ jsx("span", { className: "text-white", children: "CRM" })
        ] })
      ] }) }) }),
