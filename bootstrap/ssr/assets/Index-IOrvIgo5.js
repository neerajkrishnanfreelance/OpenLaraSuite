...
import { BookOpen, Calendar, Clock, Plus, Trash2, ArrowRight } from "lucide-react";
...
function Index({ auth, subjects, timetable, recentLogs }) {
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [
              /* @__PURE__ */ jsx("div", { className: "bg-white p-6 rounded-xl shadow-sm border border-gray-100", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-500", children: "Total Subjects" }),
                  /* @__PURE__ */ jsx("h3", { className: "text-3xl font-bold text-gray-900 mt-2", children: subjects.length })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "p-3 bg-indigo-50 rounded-lg", children: /* @__PURE__ */ jsx(BookOpen, { className: "w-6 h-6 text-indigo-600" }) })
              ] }) }),
              /* @__PURE__ */ jsx("div", { className: "bg-white p-6 rounded-xl shadow-sm border border-gray-100", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-500", children: "Weekly Scheduled" }),
                  /* @__PURE__ */ jsxs("h3", { className: "text-3xl font-bold text-gray-900 mt-2", children: [
                    timetable.length,
                    " ",
                    /* @__PURE__ */ jsx("span", { className: "text-sm font-normal text-gray-400", children: "sessions" })
                  ] })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "p-3 bg-green-50 rounded-lg", children: /* @__PURE__ */ jsx(Calendar, { className: "w-6 h-6 text-green-600" }) })
              ] }) }),
              /* @__PURE__ */ jsx("div", { className: "bg-white p-6 rounded-xl shadow-sm border border-gray-100", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-500", children: "Recent Logs" }),
                  /* @__PURE__ */ jsx("h3", { className: "text-3xl font-bold text-gray-900 mt-2", children: recentLogs.length })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "p-3 bg-blue-50 rounded-lg", children: /* @__PURE__ */ jsx(Clock, { className: "w-6 h-6 text-blue-600" }) })
              ] }) })
            ] }),
