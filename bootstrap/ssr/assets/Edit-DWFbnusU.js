...
function Edit({ auth, crop }) {
  ...
  return /* @__PURE__ */ jsxs(
    Authenticated,
    {
      header: /* @__PURE__ */ jsx(FormHeader, { title: `Edit Crop: ${crop.name}`, backRoute: "agriculture.crops.index" }),
      children: [
        /* @__PURE__ */ jsx(Head, { title: `Edit Crop: ${crop.name}` }),
        /* @__PURE__ */ jsx(FormPageLayout, { children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end mt-4", children: [
            /* @__PURE__ */ jsx(Link, { href: route("agriculture.crops.show", crop.id), className: "text-gray-600 hover:text-gray-900 mr-4", children: "Cancel" }),
            /* @__PURE__ */ jsx(PrimaryButton, { className: "ms-4", disabled: processing, children: "Update Crop" })
          ] })
        ] }) })
      ]
    }
