      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row justify-between items-center mb-6 gap-4", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "flex space-x-2", children: selectedIds.length > 0 && /* @__PURE__ */ jsxs(
              "button",
              {
          ...
          filterData.groupBy ? Object.entries(contacts.reduce((groups, contact) => {
            const key = contact[filterData.groupBy] || "Ungrouped";
            if (!groups[key]) groups[key] = [];
            groups[key].push(contact);
            return groups;
          }, {})).map(([groupName, groupContacts]) => /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
            /* @__PURE__ */ jsx("h3", { className: "font-bold text-lg text-gray-700 mb-2 px-2 border-l-4 border-indigo-500 bg-gray-50 py-1", children: groupName }),
            /* @__PURE__ */ jsx("div", { className: "bg-white overflow-hidden shadow-sm sm:rounded-lg", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [
              /* @__PURE__ */ jsx("thead", { className: "bg-gray-50", children: /* @__PURE__ */ jsxs("tr", { children: [
                /* @__PURE__ */ jsx("th", { scope: "col", className: "px-6 py-3", children: /* @__PURE__ */ jsx(
                  "input",
                  {
                    ...
                    onChange: (e) => {
                      if (e.target.checked) {
                        setSelectedIds((prev) => [.../* @__PURE__ */ new Set([...prev, ...groupContacts.map((c) => c.id)])]);
                      } else {
              ...
              /* @__PURE__ */ jsx("tbody", { className: "bg-white divide-y divide-gray-200", children: groupContacts.map((contact) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50 transition", children: [
          ...
          ] }, groupName)) : /* @__PURE__ */ jsx("div", { className: "bg-white overflow-hidden shadow-sm sm:rounded-lg", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [
            /* @__PURE__ */ jsx("thead", { className: "bg-gray-50", children: /* @__PURE__ */ jsxs("tr", { children: [
              /* @__PURE__ */ jsx("th", { scope: "col", className: "px-6 py-3", children: /* @__PURE__ */ jsx(
                "input",
                {
