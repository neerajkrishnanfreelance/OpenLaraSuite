...
import { Link as Link$1, useForm, Head } from "@inertiajs/react";
    ...
    activeTimer ? /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-4 text-sm text-gray-600 text-left bg-gray-50 p-3 rounded", children: [
        ...
        activeTimer.task_id && /* @__PURE__ */ jsxs("p", { className: "text-xs text-indigo-600 font-medium mb-1", children: [
          "Task: ",
          projects.find((p) => p.id === activeTimer.project_id)?.tasks?.find((t) => t.id === activeTimer.task_id)?.name || "Task #" + activeTimer.task_id
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
        /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Project" }),
        /* @__PURE__ */ jsxs(
          "select",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
        /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Task (Optional)" }),
        /* @__PURE__ */ jsxs(
          "select",
          {
            value: data.task_id,
            ...
            children: [
              ...
              availableTasks.map((t) => /* @__PURE__ */ jsx("option", { value: t.id, children: t.name }, t.id))
            ]
          }
        ),
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-4 gap-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "lg:col-span-1 space-y-6", children: [
            /* @__PURE__ */ jsx(ProfileCard, { user: auth.user, stats: user_stats }),
            /* @__PURE__ */ jsx(TimesheetTimerWidget, { projects, activeTimer })
          ] }),
