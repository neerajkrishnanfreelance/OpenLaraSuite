...
export default function Create({ auth, accounts, journals }) {
    const { data, setData, post, processing, errors } = useForm({
        name: '',
        description: '',
        price: '',
        is_expense: true, // Default to true since we are in Expenses
        expense_account_id: '',
        journal_id: '',
    });
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Create Expense</h2>}
        >
